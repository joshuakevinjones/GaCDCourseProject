...
This codebook is intended to satisfy the course project requirement to create a code book that describes:
  - the variables
  - the data
...
## How to run the included function (run_analysis.R)
